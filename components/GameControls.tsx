        ...
        <div className="flex flex-col gap-6 w-full h-full">
            <div className="pointer-events-auto">
                <div className="flex items-center gap-3">
                    ...
                    />
                    <h2 className="text-3xl font-black tracking-tighter italic text-gray-900 dark:text-white drop-shadow-sm uppercase">
                        GM <span className="text-blue-600 dark:text-blue-400">Recall</span>
                    </h2>
                </div>
            </div>
                    ...
                    <div className="flex justify-center gap-1 mt-2">
                        {[...Array(MAX_HINTS)].map((_, i) => (
                            <Lightbulb
                                key={i}
                                size={20}
                                className={`transition-all duration-300 ${i < gameState.hintsRemaining
